...
function notArrayEmpty<T>(array: T[]): boolean {
    return array.length > 0;
}

function get_tagName(element: Element): string {
    return element.tagName.toLowerCase();
}

function element_toHTMLText(element: Element): string {
...
function element_to_div(element: Element): HTMLDivElement {
